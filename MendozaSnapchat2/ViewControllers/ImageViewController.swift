...
//  MendozaSnapchat2
//
//  Created by Daniel Mendoza on 29/05/24.
//
...
class ImageViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func elegirContactoTapped(_ sender: Any) {
        ...
        let cargarImagen = imagenesFolder.child("\(imagenID).jpg")
            ...
            if error != nil {
                self.mostrarAlerta(titulo: "Error", mensaje: "Se produjo en error al subir la imagen. Verifique su conexion a internet y vuelva a intentarlo", accion: "Aceptar")
